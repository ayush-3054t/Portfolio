...
const Projects = () => {
    ...
    return (
        <section id="projects" className="py-16 md:py-24 bg-[#030014] relative">
            <div className="absolute top-40 left-0 w-72 h-72 md:w-[500px] md:h-[500px] bg-green-600/10 rounded-full blur-[110px] md:blur-[150px] pointer-events-none" />
            <div className="absolute bottom-40 right-0 w-72 h-72 md:w-[500px] md:h-[500px] bg-emerald-600/10 rounded-full blur-[110px] md:blur-[150px] pointer-events-none" />
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <div className="p-5 sm:p-8 flex-grow flex flex-col relative z-10">
                                ...
                                <div className="flex justify-between items-center mb-5 sm:mb-6 relative z-20">
                                    <div className="p-2.5 sm:p-3 rounded-xl bg-green-500/10 text-green-400 group-hover:bg-green-500 group-hover:text-white transition-all duration-300 shadow-sm border border-green-500/20">
                                        <Code2 size={22} />
                                    </div>
                                ...
                                <h3 className="text-xl sm:text-2xl font-bold text-slate-200 mb-4 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-green-400 group-hover:to-lime-400 transition-all duration-300">
                                    {project.title}
                                </h3>

                                <div className="flex-grow">
                                    <ul className="space-y-3 mb-6 sm:mb-8 text-slate-400 text-sm leading-relaxed">
