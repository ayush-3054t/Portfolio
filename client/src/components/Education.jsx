...
const Education = () => {
    ...
    return (
        <section id="education" className="py-24 bg-[#030014] relative">
                        ...
                        {education.map((edu, index) => (
                            <div key={index} className="relative flex flex-col md:flex-row items-center justify-between group">
                                ...
                                <motion.div
                                    ...
                                    className={`w-full md:w-[45%] ${index % 2 === 0 ? 'md:mr-auto' : 'md:ml-auto md:text-right'} p-[1px] rounded-3xl relative z-0 group-hover:z-20`}
                                >
                                    <div className="glass border border-white/5 group-hover:border-green-500/30 rounded-3xl p-8 transition-all h-full hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] hover:-translate-y-2 duration-300">
                                        <div className={`flex items-center gap-4 mb-6 ${index % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
                                            ...
                                            <h3 className="text-2xl font-bold text-slate-200 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-green-400 group-hover:to-lime-400 transition-all">
                                                {edu.degree}
                                            </h3>
                                        </div>
                                        ...
                                        <div className={`flex flex-col gap-3 mb-6 text-slate-500 ${index % 2 !== 0 ? 'md:items-end' : ''}`}>
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <span className="font-medium text-slate-300 text-lg">{edu.institution}</span>
                                            </div>
                                            <div className="flex items-center gap-2.5">
